...
public class Polycet_Cuttoff extends AppCompatActivity implements AdapterView.OnItemSelectedListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_polycet__cuttoff);
       ...
       branches.setOnClickListener(new View.OnClickListener() {
           ...
           public void onClick(View v) {
               Intent t=new Intent(getApplicationContext(),SelectBranchesPolycet.class);
        ...
        colleges.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
               // Toast.makeText(Polycet_Cuttoff.this, "Colleges", Toast.LENGTH_SHORT).show();
                Intent i=new Intent(getApplicationContext(),Cutoff_Select_Colleges_Polycet.class);
        ...
        show.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (t1.isEmpty()) {
                   ...
                   Intent i = new Intent(getApplicationContext(), Polycet_Cutoff_Result.class);
