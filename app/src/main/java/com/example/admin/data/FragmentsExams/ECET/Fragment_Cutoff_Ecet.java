...
import com.example.admin.data.examEcet.Ecet_Cutoff_Result;
import com.example.admin.data.examEcet.SelectBranchesEcet;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
       ...
       /* rank.setInputType(InputType.TYPE_NULL);
        ...
        branches.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent i=new Intent(getContext(), SelectBranchesEcet.class);
        ...
        colleges.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent j=new Intent(getContext(), Cutoff_Select_Colleges_Ecet.class);
        ...
        show.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (t1.isEmpty()) {
                    ...
                    Intent i = new Intent(getContext(), Ecet_Cutoff_Result.class);
