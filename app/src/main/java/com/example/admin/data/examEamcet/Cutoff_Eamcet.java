...
public class Cutoff_Eamcet extends AppCompatActivity implements AdapterView.OnItemSelectedListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_cutoff__eamcet);
       ...
       councling.setOnItemSelectedListener(this);
        ...
        colleges.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent j=new Intent(getApplicationContext(),Cutoff_Select_Colleges.class);
        ...
        show.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (t1.isEmpty()) {
                    Toast.makeText(Cutoff_Eamcet.this, "Please provide Rank", Toast.LENGTH_SHORT).show();
                }
                else if(Integer.parseInt(t1)==0){
                    Toast.makeText(Cutoff_Eamcet.this, "Please provide valid rank", Toast.LENGTH_SHORT).show();

                }
                else if(d1.length<=0){
                    Toast.makeText(Cutoff_Eamcet.this, "Please select Branches", Toast.LENGTH_SHORT).show();
                }
                else {
                    Intent i = new Intent(Cutoff_Eamcet.this, Eamcet_Cutoff_Result.class);
