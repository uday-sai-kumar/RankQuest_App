...
public class Emcet_Statastics_Graphs extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_emcet__statastics__graphs);
    ...
    public  void pie(int oc,int bca,int bcb,int bcc,int bcd,int bce,int sc,int st){
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.N) {
            pieChart.forceHasOverlappingRendering(false);
        }

        Log.i("Percent ", String.valueOf(pieChart.isUsePercentValuesEnabled()));
        pieChart.setData(data);
        pieChart.setEntryLabelColor(Color.BLACK);
        description2.setText("Category - Analysis");
...
// initialize the Bardata with argument labels and dataSet
       ...
       // barChart.getXAxis().setAxisMinValue(0);
        ...
        description1.setText("Boys vs Girls - Analysis");
        ...
        try {
            ...
            call1.enqueue(new Callback<List<TotalSeats>>() {
                ...
                public void onResponse(Call<List<TotalSeats>> call, Response<List<TotalSeats>> response) {
                    ...
                    int y=m+f;
                    String t=list1.get(0).getTotalseats();
                    if(t=="0") {
                        total.setText("Total Seats Filled is : " + y + "/NA" );
                    }
                    else {
                        total.setText("Total Seats Filled is : " + y + "/" +t);
                    }
                }
