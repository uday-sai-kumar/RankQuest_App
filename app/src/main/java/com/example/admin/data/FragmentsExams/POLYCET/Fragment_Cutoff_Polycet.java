...
import com.example.admin.data.examPolycet.Cutoff_Select_Colleges_Polycet;
import com.example.admin.data.examPolycet.Polycet_Cutoff_Result;
import com.example.admin.data.examPolycet.SelectBranchesPolycet;
...
public class Fragment_Cutoff_Polycet extends Fragment implements AdapterView.OnItemSelectedListener{
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view= inflater.inflate(R.layout.fragment_fragment__cutoff__polycet, container, false);
       ...
       /* rank.setInputType(InputType.TYPE_NULL);
        rank.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                mgr.showSoftInput(rank, InputMethodManager.SHOW_FORCED);
            }
        });*/
        ...
        branches.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent i=new Intent(getContext(), SelectBranchesPolycet.class);
        ...
        colleges.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent j=new Intent(getContext(), Cutoff_Select_Colleges_Polycet.class);
        ...
        show.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (t1.isEmpty()) {
                    ...
                    Intent i = new Intent(getContext(), Polycet_Cutoff_Result.class);
