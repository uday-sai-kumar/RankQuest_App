...
public class Ecet_Cutoff extends AppCompatActivity implements AdapterView.OnItemSelectedListener{
    MaterialCardView show, branches, colleges;
    EditText rank;
    RadioGroup gg,g;
    Spinner cast, councling;
    RadioButton male,female,college,bran;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_ecet__cutoff);
        ...
        branches.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent t=new Intent(getApplicationContext(),SelectBranchesEcet.class);
        ...
        colleges.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                // Toast.makeText(Polycet_Cuttoff.this, "Colleges", Toast.LENGTH_SHORT).show();
                Intent i=new Intent(getApplicationContext(),Cutoff_Select_Colleges_Ecet.class);
        ...
        show.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (t1.isEmpty()) {
                    ...
                    Intent i = new Intent(getApplicationContext(),Ecet_Cutoff_Result.class);
