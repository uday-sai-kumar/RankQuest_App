...
import com.example.admin.data.examPgecet.Cutoff_Select_Colleges_Pgcet;
import com.example.admin.data.examPgecet.Pgcet_Cutoff_Result;
import com.example.admin.data.examPgecet.SelectBranchesPgcet;
...
public class Fragment_Cutoff_pgcet extends Fragment implements AdapterView.OnItemSelectedListener{
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view =  inflater.inflate(R.layout.fragment_fragment__cutoff_pgcet, container, false);
       ...
       /* rank.setInputType(InputType.TYPE_NULL);
        ...
        branches.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent i=new Intent(getContext(), SelectBranchesPgcet.class);
        ...
        colleges.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent j=new Intent(getContext(), Cutoff_Select_Colleges_Pgcet.class);
        ...
        show.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (t1.isEmpty()) {
                    ...
                    Intent i = new Intent(getContext(), Pgcet_Cutoff_Result.class);
